	...
	<div id="wrapper">
    	<div id="t02">
    		...
    		<div id="t02L">
                ...
                <div class="lu01">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $slug; ?>/sumica100_logo.jpg" />
                </div>
                <div class="lu01">
                    <p>sumica100とはフェリックスハウスと一級建築事務所A1・IDの<br />共同開発で誕生したメイドイン北摂のコンセプトハウスです。</p>
                ...
                <div class="lu03">
                    <dl>
                        <dt>それぞれのライフスタイルに合わしたモデルプラン。</dt>
                        <dd>新しい住まいのイメージは十人十色です。sumica100では様々なお客様のご要望に応えるよう成長するお子様、家族それぞれの趣味・ライフスタイルを尊重して創られました。ライフスタイルによって変化するプランの一例をご紹介します。</dd>
                    </dl>
                </div>
                <div class="lu01">
                ...
                <div class="lu01">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $slug; ?>/gooddesign.jpg" />
                </div>
                <div class="ptitle">
